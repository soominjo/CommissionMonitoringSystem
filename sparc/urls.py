...
urlpatterns = [
    ...
    path('create-combined-voucher/', views.create_combined_voucher, name='create_combined_voucher'),
    ...
    path('approve/autocomplete/', views.user_autocomplete, name='user_autocomplete'),
    path('user-filter-autocomplete/', views.user_filter_autocomplete, name='user_filter_autocomplete'),
    ...
    path('update-gross-commission/', views.update_gross_commission, name='update_gross_commission'),
    path('update-total-gross-commission/', views.update_total_gross_commission, name='update_total_gross_commission'),
    ...
    path('update-individual-tranche/', views.update_individual_tranche, name='update_individual_tranche'),
